...
function Home() {
  return (
    <>
      <Helmet>
        <title>Siemes Homepage</title>
        <meta name="description" content="Visit our homepage to check its contents" />
        <link rel="canonical" href="/" />
      </Helmet>

      <div className="bg-black min-h-screen text-[#f5f5f5]">
        ...
        <main>
          <section className="relative pb-32">
            ...
            <div className="grid gap-12 relative place-items-center lg:pb-44 max-w-desktop">
              ...
              <Link to="/signup" className="raleway-700 w-max py-4.5 px-16 rounded-xl bg-black">Get Started Free</Link>
            </div>
          ...
          <section className="grid place-items-center">
            <a href="https://www.upwork.com/freelancers/~01717c695f5f69880c?s=general" target="_blank" className="w-max border flex gap-3 items-center pr-5.5 border-[#2A2A2A] rounded-xl h-21">
              <div className="flex items-center">
                <img loading="lazy" src={Client1} alt="client 1 image" className="z-40 translate-x-[calc(4px_*_4)]" />
                <img loading="lazy" src={Client2} alt="client 2 image" className="z-30 translate-x-[calc(4px_*_3)]" />
                <img loading="lazy" src={Client3} alt="client 3 image" className="z-20 translate-x-[calc(4px_*_2)]" />
                <img loading="lazy" src={Client4} alt="client 4 image" className="z-10 translate-x-[calc(4px_*_1)]" />
                <img loading="lazy" src={Client5} alt="client 5 image" className="z-0 " />
              </div>
              <div>
